# Generated by Django 4.1.7 on 2023-12-05 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('O', 'Orgánico'), ('C', 'Convencional')], default='C', max_length=12, verbose_name='Condición')),
                ...
                ('discount_price_soles', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=15, null=True, verbose_name='Soles Descuento Precio')),
                ('service_downloads', models.DecimalField(blank=True, decimal_places=3, default=0.0, max_digits=9, null=True, verbose_name='Servicio de descarga')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lot', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Lote')),
                ('plant', models.CharField(blank=True, max_length=50, null=True, verbose_name='Planta')),
                ('departure_date', models.DateField(blank=True, null=True, verbose_name='Fecha de salida Campo')),
                ('entry_date', models.DateField(blank=True, null=True, verbose_name='Fecha de entrada')),
                ('unload_date', models.DateField(blank=True, null=True, verbose_name='Fecha de descarga')),
                ('variety', models.CharField(blank=True, max_length=50, null=True, verbose_name='Variedad')),
                ('condition', models.CharField(blank=True, max_length=50, null=True, verbose_name='Condicion')),
                ('transport', models.CharField(blank=True, max_length=100, null=True, verbose_name='Transporte')),
                ('carrier_guide', models.CharField(blank=True, max_length=50, null=True, verbose_name='Guia de transportista')),
                ('supplier_guide', models.CharField(blank=True, max_length=50, null=True, verbose_name='Guia de proveedor')),
                ('invoice', models.CharField(blank=True, max_length=50, null=True, verbose_name='Factura')),
                ('supplier', models.CharField(blank=True, max_length=100, null=True, verbose_name='Proveedor')),
                ('origin', models.CharField(blank=True, max_length=100, null=True, verbose_name='Procedencia')),
                ('plot', models.CharField(blank=True, max_length=200, null=True, verbose_name='Parcela')),
                ('average_crates', models.FloatField(blank=True, null=True, verbose_name='Promedio jabas')),
                ('crates_quantity', models.PositiveIntegerField(blank=True, null=True, verbose_name='Cantidad de jabas')),
                ('gross_weight', models.FloatField(blank=True, null=True, verbose_name='Peso bruto')),
                ('tare', models.FloatField(blank=True, null=True, verbose_name='Tara')),
                ('net_weight', models.FloatField(blank=True, null=True, verbose_name='Peso neto')),
                ('guide_weight', models.FloatField(blank=True, null=True, verbose_name='Peso guia')),
                ('net_weight_difference_with_guide', models.FloatField(blank=True, null=True, verbose_name='Diferencia netos con guia')),
                ('rejection_percentage', models.FloatField(blank=True, null=True, verbose_name='% Rechazo')),
                ('rejected_weight', models.FloatField(blank=True, null=True, verbose_name='Kg rechazados')),
                ('usable_weight', models.FloatField(blank=True, null=True, verbose_name='Kg aprovechables')),
                ('discount_percentage', models.FloatField(blank=True, null=True, verbose_name='% Descuento S/')),
                ('discount', models.FloatField(blank=True, null=True, verbose_name='Descuento S/')),
                ('field_price', models.FloatField(blank=True, null=True, verbose_name='Precio Campo')),
                ('plant_price', models.FloatField(blank=True, null=True, verbose_name='Precio planta')),
                ('freight', models.FloatField(blank=True, null=True, verbose_name='Flete')),
                ('palletizing_per_kg', models.FloatField(blank=True, null=True, verbose_name='Estiba/kg')),
                ('total_to_pay_to_plant', models.FloatField(blank=True, null=True, verbose_name='Total a pagar planta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kg', models.FloatField(default=0, verbose_name='Kg')),
                ('destine', models.CharField(choices=[('P', 'Producción'), ('M', 'Merma'), ('I', 'I+D')], default='P', max_length=1, verbose_name='Destino')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
