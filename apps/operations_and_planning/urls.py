...
from apps.operations_and_planning.views import ListRecordsView, ListMaterialView, ListProductView, DetailProductView, \
    DetailMaterialView, ListStockView, ListStockEntryView, ListStockExitView, ListStockAvailableView, \
    ListStockReEntryView, ListPlanningProductionView, ListProductionPlanningView, DetailProductionPlanningView, \
    CalendarScheduleManufacturingView
