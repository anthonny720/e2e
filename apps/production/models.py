...
class MOD(models.Model):
    ...
    people_conditioning_afternoon = models.IntegerField(verbose_name='Personas Acondicionado Tarde', default=0)
    people_conditioning_afternoon_hours = models.DecimalField(verbose_name='Horas Acondicionado Tarde', default=0,
                                                              max_digits=4, decimal_places=2)
    cmo_conditioning_afternoon = models.DecimalField(max_digits=6, decimal_places=2,
                                                     verbose_name='CMO Acondicionado Tarde', default=0)
    people_conditioning_night = models.IntegerField(verbose_name='Personas Acondicionado Noche', default=0)
    people_conditioning_night_hours = models.DecimalField(verbose_name='Horas Acondicionado Noche', default=0,
                                                          max_digits=4, decimal_places=2)
    cmo_conditioning_night = models.DecimalField(max_digits=6, decimal_places=2, verbose_name='CMO Acondicionado Noche',
                                                 default=0)
    people_conditioning = models.IntegerField(verbose_name='Personas Acondicionado', default=0)
    people_conditioning_hours = models.DecimalField(verbose_name='Horas Acondicionado', default=0, max_digits=4,
                                                    decimal_places=2)
    ...
    people_conditioning_25_hours = models.DecimalField(verbose_name='Horas Acondicionado 25%', default=0, max_digits=4,
                                                       decimal_places=2)
    ...
    people_conditioning_35_hours = models.DecimalField(verbose_name='Horas Acondicionado 35%', default=0, max_digits=4,
                                                       decimal_places=2)
    cmo_conditioning_35 = models.DecimalField(max_digits=6, decimal_places=2, verbose_name='CMO Acondicionado 35%',
                                              default=0)
    people_conditioning_rest = models.IntegerField(verbose_name='Personas Acondicionado Descanso', default=0)
    people_conditioning_absence = models.IntegerField(verbose_name='Personas Acondicionado Inasistencia', default=0)
    ...
    people_packing_25_hours = models.DecimalField(verbose_name='Horas Envasado 25%', default=0, max_digits=4,
                                                  decimal_places=2)
    ...
    people_packing_35_hours = models.DecimalField(verbose_name='Horas Envasado 35%', default=0, max_digits=4,
                                                  decimal_places=2)
    ...
    people_packing_rest = models.IntegerField(verbose_name='Personas Envasado Descanso', default=0)
    people_packing_absence = models.IntegerField(verbose_name='Personas Envasado Inasistencia', default=0)
