...
class MOD(models.Model):
    ...
    worker_rest_day_cost = models.DecimalField(max_digits=7, decimal_places=2, verbose_name='Costo Día Descanso Trabajador', default=0)
    worker_night_shift_cost = models.DecimalField(max_digits=7, decimal_places=2, verbose_name='Costo Noche Trabajador', default=0)
    worker_day_shift_cost = models.DecimalField(max_digits=7, decimal_places=2, verbose_name='Costo Día Trabajador', default=0)
    supervisor_rest_day_cost = models.DecimalField(max_digits=7, decimal_places=2, verbose_name='Costo Día Descanso Supervisor', default=0)
    supervisor_day_shift_cost = models.DecimalField(max_digits=7, decimal_places=2, verbose_name='Costo Día Supervisor', default=0)
