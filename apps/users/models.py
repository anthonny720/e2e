...
class UserAccount(AbstractBaseUser, PermissionsMixin):
    ...
    class Roles(models.TextChoices):
        ...
        PLANIFICACION_PRODUCCION = 'PLANIFICACION_PRODUCCION', 'Planner Producción'
        PLANIFICACION_LOGISTICA = 'PLANIFICACION_LOGISTICA', 'Planner Logística'
        COMPRAS = 'COMPRAS', 'Compras'
        ACOPIO = 'ACOPIO', 'Acopio'
        CONTABILIDAD = 'CONTABILIDAD', 'Contabilidad'
        GERENCIA = 'GERENCIA', 'Gerencia'
        COMERCIAL = 'COMERCIAL', 'Comercial'
        PLANIFICACION_ANALISTA = 'PLANIFICACION_ANALISTA', 'Analista de Datos'
