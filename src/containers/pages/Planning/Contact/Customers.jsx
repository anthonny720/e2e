...
import {add_customer, delete_customer, get_customers} from "../../../../redux/actions/management";
...
const Customers = () => {
    ...
    const handleAddForm = () => {
        ...
        setContent(<div className={"h-full md:h-screen"}>
            ...
            <FormContact close={openModal} add_model={add_customer}/>
