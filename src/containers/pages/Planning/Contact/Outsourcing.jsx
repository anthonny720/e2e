...
import {add_outsourcing, delete_outsourcing, get_outsourcings} from "../../../../redux/actions/management";
...
const Outsourcing = () => {
    ...
    const handleAddForm = () => {
        ...
        setContent(<div className={"h-full md:h-screen"}>
            <FormContact close={openModal} add_model={add_outsourcing}/>
        </div>)
    }
    ...
    return (<Planning>
        ...
        <div class="relative overflow-x-auto scrollbar-hide  sm:rounded-lg p-2 max-h-[450px] md:max-h-[550px]">
            <Table reference={tableRef} data={payload} onLoad={get_outsourcings} path={'outsourcings'} onRemove={delete_outsourcing}/>
        </div>
    </Planning>);
};
