                ...
                <table className="min-w-full bg-white " ref={reference}>
                    ...
                    {data && data.map((item, index) => {
                        return (<tr className="h-16 border-gray-300  border-b " key={index}>
                            ...
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.maturation_4}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.maturation_total}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.mechanical_damages}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.broken_neck}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.chafing}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.scar}</td>
                            <td className="text-sm px-6 whitespace-no-wrap text-gray-800 font-normal  text-center">{item?.discard}</td>
