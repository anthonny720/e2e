...
const newSchema = () => {
    return {
        ...
        weight: Yup.number().min(0).max(2000).required(true),
        gb: Yup.number().min(0).max(99).integer("Ingrese un número entre 0 - 99").required(true),
        ...
        c12: Yup.number().min(0).max(99).integer("Ingrese un número entre 0 - 99").required(true),
        c14: Yup.number().min(0).max(99).integer("Ingrese un número entre 0 - 99").required(true),
