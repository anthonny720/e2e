    ...
    return (<div className="w-full flex mt-4 flex-wrap gap-2 overflow-auto scrollbar-hide">
        ...
        <div
            ...
            <div className="my-auto">
                ...
                <div className="md:text-2xl text-xl text-green-100">S/ {Humanize.formatNumber((get_price()/get_kg_usable())||0 , 2)}</div>
            </div>
            <div
                className="hidden sm:block text-green-300 my-auto bg-gradient-to-l from-green-700 via-green-800 to-green-900 rounded-full p-4">
        ...
        <div
            ...
            <div className="my-auto">
                ...
                <div
                    className="md:text-2xl text-xl text-green-100">S/ {Humanize.formatNumber(get_price(), 2)}</div>
            </div>
            <div
                className="hidden sm:block text-green-300 my-auto bg-gradient-to-l from-green-700 via-green-800 to-green-900 rounded-full p-4">
