...
const StorageArea = () => {
    ...
    const payload = useSelector(state => state.Management.storage)
    ...
    useEffect(() => {
        dispatch(get_storage_areas(formData))
    }, [formData]);


    return (<Settings>
        <h1 className={"text-gray-800 flex w-full p-2 text-xs md:text-lg "}>Area de almacenamiento</h1>
