...
import {get_currencies} from "../../../redux/actions/management";
...
const Currency = () => {
    ...
    const payload = useSelector(state => state.Management.currencies)
    ...
    useEffect(() => {
        dispatch(get_currencies(formData))
    }, [formData]);


    return (<Settings>
        <h1 className={"text-gray-800 flex w-full p-2 text-xs md:text-lg "}>Moneda</h1>
