...
import {get_containers} from "../../../redux/actions/management";
import {map, size} from "lodash";
import Skeleton from "react-loading-skeleton";

const Container = () => {

    const payload = useSelector(state => state.Management.containers)
    ...
    useEffect(() => {
        dispatch(get_containers(formData))
    }, [formData]);


    return (<Settings>
        <h1 className={"text-gray-800 flex w-full p-2 text-xs md:text-lg "}>Envases</h1>
